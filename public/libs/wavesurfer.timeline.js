...
/***/ ((module, exports) => {
                    ...
                    var TimelinePlugin = /*#__PURE__*/function () {
                        ...
                        _createClass(TimelinePlugin, [{
                            ...
                            key: "fillArc",
                            value: function fillArc(x, y, width, height, radius) {
                                var _this4 = this;
                                try{
                                    this.canvases.forEach(function (canvas, i) {
                                        var leftOffset = i * _this4.maxCanvasWidth;
                                        ...
                                        if (intersection.x1 < intersection.x2) {
                                            var context = canvas.getContext('2d');
                                            if (context) {
                                                var endAngle = Math.PI + (Math.PI * 50) / 2; // End point on circle
                                                context.beginPath();
                                                context.arc(intersection.x1 - leftOffset, intersection.y1, radius, 0, endAngle, true);
                                                // context.stroke();
